...
tangelo.newScript("/js/loader/load-jquery.min.js");
tangelo.newScript("/js/loader/load-d3.min.js");
tangelo.newScript("/js/loader/load-bootstrap.js");
tangelo.newScript("/js/tangelo.min.js");
