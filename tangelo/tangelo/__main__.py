...
def main():
    ...
    p.add_argument("--list-dir", action="store_const", const=True, default=None, help="enable directory content serving")
    p.add_argument("--no-list-dir", action="store_const", const=True, default=None, help="disable directory content serving")
    p.add_argument("--show-py", action="store_const", const=True, default=None, help="enable Python service source code serving")
    p.add_argument("--no-show-py", action="store_const", const=True, default=None, help="disable Python service source code serving")
