$(function () {
    ...
    $("#content").geodots({
        data: data,
        worldGeometry: "../world-110m.json",
        latitude: tangelo.accessor({field: "lat"}),
        longitude: tangelo.accessor({field: "lon"}),
        size: tangelo.accessor({field: "value"}),
        color: tangelo.accessor({field: "group"})
    });
});
